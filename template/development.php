...
<main id="main" class="main development">
    ...
    $development_project_arr = array(
        array(
            ...
            "img1" => "./assets/img/design/development-rosewood1.png",
            "img2" => "./assets/img/design/development-rosewood2.png",
            "img3" => "./assets/img/design/development-rosewood3.png",
            "img4" => "./assets/img/design/development-rosewood4.png",
            "img5" => "./assets/img/design/development-rosewood5.png",
        ...
        array(
            ...
            "img1" => "./assets/img/design/development-intercontinental1.png",
            "img2" => "./assets/img/design/development-intercontinental2.png",
            "img3" => "./assets/img/design/development-intercontinental3.png",
            "img4" => "./assets/img/design/development-intercontinental4.png",
            "img5" => "./assets/img/design/development-intercontinental5.png",
        ...
        array(
            ...
            "img1" => "./assets/img/design/development-swan-lake1.png",
            "img2" => "./assets/img/design/development-swan-lake2.png",
            "img3" => "./assets/img/design/development-swan-lake3.png",
            "img4" => "./assets/img/design/development-swan-lake4.png",
            "img5" => "./assets/img/design/development-swan-lake5.png",
            "img6" => "./assets/img/design/development-swan-lake6.png",
            "img6-m" => "./assets/img/design/development-swan-lake6-m.png",
            "image-side" => "image-side-right",
            "template" => "type-2",
        )
    );
                    ...
                    <div class="swiper-wrapper">
                        ...
                        $location_arr = array(
                            array(
                                ...
                                "bg-image" => "../../../assets/img/design/under-development1.png",
                            ),
                            array(
                                ...
                                "bg-image" => "../../../assets/img/design/under-development2.png",
                            ),
                            array(
                                ...
                                "bg-image" => "../../../assets/img/design/under-development3.png",
                            ),
                            array(
                                "title" => "BANGKOK RIVERSIDE LUXURY HOTEL AND RESIDENCES",
                                "description" => "Elegance reimagined by the river: submerge yourself in tranquility at the Luxury Hotel and Residences, where riverside delights meet refined elegance.",
